  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "emam.khalid.jion@email.com",
      href: "mailto:emam.khalid.jion@email.com",
    },
    {
      icon: Phone,
      label: "Phone",
  ...
  return (
    <section id="contact" className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 items-center justify-center border border-red-700 gap-12">
          {/* Contact Info */}
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="space-y-8 border border-blue-500"
          >
            <div>
